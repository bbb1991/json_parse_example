...
public class Education implements Serializable {
    ...
    private final static long serialVersionUID = -52104544038809539L;
     ...
     * @param alias
     */
    public Education(long id, String title, Object alias) {
        super();
        this.id = id;
        this.title = title;
        this.alias = alias;
    ...
    public Education withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Education withAlias(Object alias) {
        this.alias = alias;
        return this;
    }
